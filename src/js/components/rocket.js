...
export default class Rocket extends React.Component {
    ...
    render() {
        return (
            <svg version='1.1' id='rocket' className={ this.state.active }
                 xmlns='http://www.w3.org/2000/svg' x='0px' y='0px'
                 viewBox='0 0 300 300' enable-background='new 0 0 300 300'>
                <g id='laptop'>
                    <path className="st0" fill="#38454F"
                          d="M108.9,259.9V271h83v-11.1h88.2V82c0-6.1-4.6-11.1-10.4-11.1H31.1c-5.7,0-10.4,5-10.4,11.1v177.9H108.9z"/>
                    <path className="st1" fill="#B0B6BB"
                          d="M191.9,261.5v9.4h-83v-9.4H0v14.2c0,5.2,4.6,9.4,10.4,9.4h280.1c5.7,0,10.4-4.2,10.4-9.4v-14.2H191.9z"/>
                    <polygon className="st2" fill="#FFFFFF" points="31.1,252.1 269.7,252.1 269.7,80.3 31.1,80.3"/>
                </g>
                <g className='s-star'>
		...
		C171.4,73.5,161.8,58.7,150,58.7z'/>
			...
			c-0.2,0.1-0.4,0.1-0.6,0.1H162.6z'/>
                ...
                v3.3c2.9,0.2,5.6,1.6,7.4,3.7C157.7,120.5,154.9,117.7,151.5,117.2z'/>
                        ...
                        <line fill='#FFFFFF' stroke='#333333' stroke-width='3' stroke-linecap='round' stroke-linejoin='round' stroke-miterlimit='10'
                              x1='150' y1='241.3' x2='150' y2='198.1'/>
                    </g>
                </g>
            </svg>
        );
